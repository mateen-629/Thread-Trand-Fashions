...
img2:"https://images.unsplash.com/photo-1559127452-56b800eb2f23?q=80&w=900&auto=format&fit=crop",
  ...
  const REVIEWS = [
    { name:"Ayesha Khan", role:"Verified Buyer", stars:5, quote:"The overcoat is heavier and better made than anything near this price. It genuinely looks like it cost three times as much.", avatar:"https://images.unsplash.com/photo-1536766768598-e09213fdcf22?q=80&w=200&auto=format&fit=crop" },
    { name:"Ahmed Raza", role:"Verified Buyer", stars:5, quote:"Ordered the merino polo in two colours after the first one arrived. Sizing was exactly true to the chart, no surprises.", avatar:"https://images.unsplash.com/photo-1607346256330-dee7af15f7c5?q=80&w=200&auto=format&fit=crop" },
    { name:"Fatima Malik", role:"Verified Buyer", stars:5, quote:"The wrap dress photographs beautifully but wears even better — the silk has real weight to it and doesn't crease.", avatar:"https://images.unsplash.com/photo-1584367034980-8ba72c175f4f?q=80&w=200&auto=format&fit=crop" },
